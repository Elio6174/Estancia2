...
<label class="fixed inset-0 bg-black/60 z-30 hidden lg:hidden cursor-pointer" for="menu-toggle" id="overlay"></label>
<aside class="w-64 bg-[#0d1b2a] text-white p-4 flex flex-col justify-between fixed inset-y-0 left-0 transform -translate-x-full transition-transform duration-300 ease-in-out z-40 lg:relative lg:translate-x-0 lg:flex" id="sidebar">
<div>
...
<label class="lg:hidden cursor-pointer text-text-dark/80 hover:text-white" for="menu-toggle">
...
<main class="flex-1 p-4 md:p-6 lg:p-8 flex flex-col gap-6">
...
<p class="text-text-light/60 dark:text-text-dark/60 text-sm md:text-base">Resumen de su actividad diaria.</p>
</div>
</div>
<div class="flex items-center gap-2 lg:hidden">
<label class="cursor-pointer p-2 rounded-full hover:bg-gray-200 dark:hover:bg-surface-dark" for="alerts-toggle">
<span class="material-symbols-outlined">notifications</span>
</label>
<label class="cursor-pointer p-2 rounded-full hover:bg-gray-200 dark:hover:bg-surface-dark" for="tasks-toggle">
...
<p class="text-sm text-text-light/60 dark:text-text-dark/60">09:00 - 09:30 AM</p>
</div>
<span class="px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-200">Confirmada</span>
</div>
<div class="flex items-center justify-between p-3 border border-border-light dark:border-border-dark rounded">
<div>
<p class="font-semibold">Maria Rodriguez</p>
<p class="text-sm text-text-light/60 dark:text-text-dark/60">10:30 - 11:00 AM</p>
</div>
<span class="px-2 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full dark:bg-yellow-900 dark:text-yellow-200">Pendiente</span>
</div>
<div class="flex items-center justify-between p-3 border border-border-light dark:border-border-dark rounded">
<div>
<p class="font-semibold">Sofia Garcia</p>
<p class="text-sm text-text-light/60 dark:text-text-dark/60">11:00 - 11:30 AM</p>
</div>
<span class="px-2 py-1 text-xs font-medium text-gray-700 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-200">Cancelada</span>
</div>
</div>
...
<div class="space-y-2">
<p class="text-sm"><strong>Mañana:</strong> 5 citas programadas</p>
<p class="text-sm"><strong>Esta semana:</strong> 23 citas programadas</p>
</div>
...
<p class="text-xs text-text-light/60 dark:text-text-dark/60">Mañana, 8:00 AM</p>
</div>
</div>
<div class="flex items-center gap-3 p-2 border border-border-light dark:border-border-dark rounded">
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-8" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuATJn5QwYPv9__VsaX0rlDfujVs24BDJw69jQ75MkdNW2GM4FaFeA9aRDKQlTvNbHEnKddLzPiZo2yw4rpRG3l7jcXsaW-fGj9ZJNw5s7Cye_MPNUU53xZsoCeLNEjAkYxqS3V6uP5bI8syiw7shd54zXo5FqBPNEMEh2vew1WPJ-TOL-y0cY9CFj17IVDnf2--6K9l0eO1Org75TNhIr5GZEVZ_xd_i8lks7ynOAvTuEUSlXm6HlujRzouUnUc5br4NtYFMt7VVFrX");'></div>
<div>
<p class="font-semibold text-sm">Laura Jimenez</p>
<p class="text-xs text-text-light/60 dark:text-text-dark/60">Mañana, 9:30 AM</p>
</div>
</div>
</div>
</div>
...
<div class="fixed inset-0 bg-black/60 z-50 hidden items-center justify-center p-4" id="alerts-modal">
<label class="absolute inset-0 cursor-pointer" for="alerts-toggle"></label>
<div class="window bg-surface-light dark:bg-surface-dark w-full max-w-lg max-h-[90vh] flex flex-col relative">
...
<p class="text-sm mt-1">La farmacia solicitó aclaración sobre la receta de Laura Jimenez.</p>
<button class="text-sm font-semibold text-primary mt-2">Marcar como leído</button>
</div>
...
<p class="text-sm mt-1">Posible interacción farmacológica para el paciente Miguel Castro.</p>
</div>
</div>
</div>
</div>
<input class="hidden" id="tasks-toggle" type="checkbox"/>
<div class="fixed inset-0 bg-black/60 z-50 hidden items-center justify-center p-4" id="tasks-modal">
